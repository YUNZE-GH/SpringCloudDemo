<template>
    <div class="weChat">
        <router-link  :to="{name:'Login'}"><el-button type="primary" @click="closeWebSocket">退出聊天室</el-button></router-link>
        <br />
...
export default {
    ...
    mounted: function () {
        if ("WebSocket" in window) {
            webSocket = new WebSocket(
                "/websocket/websocket/" + this.form.username
            );
            // 连通之后的回调事件
    ...
    methods: {
        ...
        closeWebSocket: function () {
            // 直接关闭websocket的连接
            // webSocket.close();
            this.$message.success({ message: "退出聊天室成功！", center: true });
        },
        send: function () {
